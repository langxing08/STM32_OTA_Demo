...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END LPUART1_MspInit 0 */
    ...
    PC1     ------> LPUART1_TX 
    */
    GPIO_InitStruct.Pin = OTA_UART_RX_Pin|OTA_UART_TX_Pin;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PC1     ------> LPUART1_TX 
    */
    HAL_GPIO_DeInit(GPIOC, OTA_UART_RX_Pin|OTA_UART_TX_Pin);
  ...
  if(huart->Instance == LPUART1)
  {
    if(__HAL_UART_GET_FLAG(huart, UART_FLAG_IDLE) != RESET)
    {
      ...
      HAL_UART_DMAStop(&hlpuart1);
		  ...
		  S_Data_From_Uart.S_DataLenth = RX_BUFF_LEN - temp;
			S_Data_From_Uart.S_DataReceiveFlag = 1;
      HAL_UART_Receive_DMA(&hlpuart1,S_Data_From_Uart.S_ReceiveBuff,RX_BUFF_LEN);
    }
  }
}
/* USER CODE END 1 */
